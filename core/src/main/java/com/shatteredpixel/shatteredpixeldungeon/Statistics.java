...
public class Statistics {
	...
	//BOSS专用
	public static boolean envDangerous=false;//危险的环境，指boss的特殊阶段
	public static int DKGhoulNum,DKMonkNum,DKWarlockNum,DKGolemNum;
	...
	public static void reset() {
		...
		ascended = false;
		envDangerous=false;
		DKGhoulNum=DKMonkNum=DKWarlockNum=DKGolemNum=0;
	}
	...
	private static final String ENVDANGEROUS	= "envDangerous";
	private static final String DKGHOULNUM="dkghoulnum";
	private static final String	DKMONKNUM="dkmonknum";
	private static final String	DKWARLOCKNUM="dkwarlocknum";
	private static final String	DKGOLEMNUM="dkgolemnum";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put(ENVDANGEROUS,  envDangerous );
		bundle.put(DKGOLEMNUM,DKGolemNum);
		bundle.put(DKGHOULNUM,DKGhoulNum);
		bundle.put(DKMONKNUM,DKMonkNum);
		bundle.put(DKWARLOCKNUM,DKWarlockNum);
	}
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		envDangerous    = bundle.getBoolean( ENVDANGEROUS );
		DKGhoulNum=bundle.getInt(DKGHOULNUM);
		DKGolemNum=bundle.getInt(DKGOLEMNUM);
		DKMonkNum=bundle.getInt(DKMONKNUM);
		DKWarlockNum =bundle.getInt(DKWARLOCKNUM);
	}
