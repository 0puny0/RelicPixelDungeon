...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.CeremonialDagger;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.PiercingBlade;
...
public abstract class Char extends Actor {
	...
	public boolean attack( Char enemy, float dmgMulti, float dmgBonus, float accMulti ) {
		...
		if (enemy.isInvulnerable(getClass())) {
			...
			if (prep != null){//刺客暗杀效果
				...
				dmg = damageRoll();
				if(this instanceof Mob&&alignment==Alignment.ALLY){
			...
			if(this instanceof Hero){
				Talent.onAttackDodged((Hero) this,enemy);
			}
			if(buff(Aim.class)!=null){
				buff(Aim.class).detach();
			}
	...
	public void damage( int dmg, Object src ) {
		...
		if (!(src instanceof Hunger)&&!(src instanceof CeremonialDagger)){
			for (ShieldBuff s : buffs(ShieldBuff.class)){
