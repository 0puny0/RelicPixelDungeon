...
public abstract class Mob extends Char {
	...
	public AiState SLEEPING     = new Sleeping();//睡眠
	public AiState HUNTING		= new Hunting();//索敌
	public AiState WANDERING	= new Wandering();//游荡
	public AiState FLEEING		= new Fleeing();//逃离
	public AiState PASSIVE		= new Passive();//疑惑(不会主动攻击)
...
//				}
			...
			if (enemies.isEmpty()){
				...
				//追逐最接近的潜在敌人，更喜欢可以攻击的敌人，如果两个敌人等距，则选择英雄go after the closest potential enemy, preferring enemies that can be attacked, and the hero if two are equidistant
				Char closest = null;
	...
	public void rollToDropLoot(){
		...
		if (buff(SoulMark.class) != null &&
			...
			Talent.onFoodEaten(Dungeon.hero, 0, Food.UNIT_ENERGY, null);
		}
