...
public class MirrorImage extends NPC {
	...
	public int defenseProc(Char enemy, int damage) {
		if(hero.belongings.weapon()!=null){
			...
			if(w!=null&&w instanceof PricklyShield){
				((PricklyShield)w).Reflect(this,enemy);
			}
		}
	...
	public float speed() {
		...
		if(hero.belongings.weapon()!=null){
			if(hero.belongings.weapon() instanceof GreatAxe){
				speed*=0.5;
			}
		}
		return speed;
	...
	protected void moveEvent() {
		if(hero.belongings.weapon()!=null&&hero.belongings.weapon() instanceof KnightLance){
