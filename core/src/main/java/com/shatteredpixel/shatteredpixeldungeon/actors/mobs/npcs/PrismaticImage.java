...
//		if(weapon!=null&&weapon instanceof PricklyShield){
//			enemy.damage(Random.NormalIntRange( 1+weapon.buffedLvl(), 2+2*weapon.buffedLvl() ),weapon);
//		}
...
//		if(weapon!=null&&weapon instanceof GreatAxe){
//			speed*=0.5;
//		}
		if (hero != null && hero.belongings.armor() != null){
			return hero.belongings.armor().speedFactor(this, speed);
		}
		return speed;
	}
	@Override
	protected void moveEvent() {
//		if(weapon instanceof KnightLance){
//			Buff.prolong(this,Impetus.class,1).raise();
//		}
		super.moveEvent();
	}
	@Override
