...
public class BrokenSeal extends Item {
	...
	public void setGlyph( ){
		...
		Armor.Glyph gl;
		gl = Armor.Glyph.random( oldGlyphClass );
		setGlyph(gl);
	}
	...
	protected static WndBag.ItemSelector armorSelector = new WndBag.ItemSelector() {
		...
		public boolean itemSelectable(Item item) {
			return item instanceof Armor&&((Armor)item).inlay== EquipableItem.Inlay.noThing;
		}
	...
	public String info() {
		...
		if(glyph!=null){
			info += "\n\n" + Messages.capitalize(Messages.get(this, "glyphed", glyph.name()));
		}
		return info;
	}
