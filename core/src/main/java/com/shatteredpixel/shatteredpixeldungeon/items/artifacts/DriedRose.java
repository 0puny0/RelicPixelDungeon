...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends DirectableAlly {
		...
		public int defenseProc(Char enemy, int damage) {
			...
			if(rose!=null&&rose.weapon!=null&&rose.weapon instanceof PricklyShield){
				((PricklyShield)rose.weapon).Reflect(this,enemy);
			}
		...
		public float speed() {
			...
			if(rose!=null&&rose.weapon!=null&&rose.weapon instanceof GreatAxe){
				speed*=0.5;
			}
			if (rose != null && rose.armor != null){
