...
public class ScrollOfTransmutation extends InventoryScroll {
	...
	protected boolean usableOnItem(Item item) {
		return (item instanceof MeleeWeapon&& !(item instanceof SpiritBow)&&((MeleeWeapon) item).inlay!= EquipableItem.Inlay.blessingPeal&&((MeleeWeapon) item).inlay!= EquipableItem.Inlay.blessedPeal )||
				...
				(item instanceof Ring &&((Ring) item).inlay!= EquipableItem.Inlay.blessedPeal )||
