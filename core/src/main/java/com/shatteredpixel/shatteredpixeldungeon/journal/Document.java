...
public enum Document {
		...
		if (page.isEmpty() || !isPageFound(page) || this != ADVENTURERS_GUIDE){
			...
			switch (page){
				...
				case "Surprise_Attacks":
					return new ItemSprite( ItemSpriteSheet.ASSASSINATION_BLADE);
				case "Prepare_Attacks":
					return new ItemSprite((ItemSpriteSheet.WAR_HAMMER));
				case "Identifying":
					return new ItemSprite( new ScrollOfIdentify() );
				case "MeleeWeapon":
					return new ItemSprite(ItemSpriteSheet.GREAT_AXE);
				case "Food":
				...
				case Document.GUIDE_SEARCHING:
					return Icons.get(Icons.MAGNIFY);
				case "Strength":
					return new ItemSprite( ItemSpriteSheet.ELIXIR_MIGHT );
				case "Upgrades":
	...
	public static final String GUIDE_PREPARE_ATKS  = "Prepare_Attacks";
	public static final String GUIDE_IDING          = "Identifying";
	public static final String GUIDE_MELEE          = "MeleeWeapon";
	...
	static {
		...
		ADVENTURERS_GUIDE.pagesStates.put(GUIDE_PREPARE_ATKS,  debug ? READ : NOT_FOUND);
		ADVENTURERS_GUIDE.pagesStates.put(GUIDE_IDING,          debug ? READ : NOT_FOUND);
		ADVENTURERS_GUIDE.pagesStates.put(GUIDE_MELEE,          debug ? READ : NOT_FOUND);
